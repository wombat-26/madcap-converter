...
const ConvertRequestSchema = z.object({
  ...
  options: z.object({
    ...
    excludeConditions: z.array(z.string()).optional(),
...
export async function POST(request: NextRequest) {
  try {
    ...
    const conversionOptions: ConversionOptions = {
      ...
      inputPath: validatedData.options?.inputPath,
      projectRootPath: validatedData.options?.projectRootPath,
      excludeConditions: validatedData.options?.excludeConditions,
      includeConditions: validatedData.options?.includeConditions,
